			...
			for(var key in excel_input) {
				if(excel_input.hasOwnProperty(key)) {
					...
					for(i=0;i<excelsheets.length;i++){
						...
						outputdata.year = gr9_para1;
						
						$.ajax({
							type: "POST",
							url: baseURL + "excelfeed/Grade9ThurunuSaviyaService.php/grade_9_thurunu_saviya_register",
							dataType: "json",
							data : outputdata,
