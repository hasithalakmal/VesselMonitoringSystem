			...
			for(var key in excel_input) {
				if(excel_input.hasOwnProperty(key)) {
					...
					for(i=0;i<excelsheets.length;i++){
						...
						outputdata.year = gr10_para1;
						
						$.ajax({
							type: "POST",
							url: baseURL + "excelfeed/Grade10ThurunuSaviyaService.php/grade_10_thurunu_saviya_register",
							dataType: "json",
							data : outputdata,
